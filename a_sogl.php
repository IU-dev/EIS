    ...
    <div class="px-4">
        <div class="table-wrapper">
            ...
            foreach ($parts as $part) {
                ...
                else if ($part['state'] == "1") echo '<td>Подписано<br><em>Подписано ' . date("d.m.Y H:i:s", strtotime($part['date_accept'] . " GMT")) . ' (' . $userTools->get_name($part['who_signed']) . ')</em></td>';
                else if ($part['state'] == "2") echo '<td>Отозвано<br><em>Подписано ' . date("d.m.Y H:i:s", strtotime($part['date_accept'] . " GMT")) . ' (' . $userTools->get_name($part['who_signed']) . ')</em><br><em>Отозвано ' . date("d.m.Y H:i:s", strtotime($part['date_null'] . " GMT")) . ' (' . $userTools->get_name($part['who_null']) . ')</em></td>';
